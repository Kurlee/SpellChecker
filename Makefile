...
dictionary.o: dictionary.c
	afl-gcc -Wall  --std=c99 -c dictionary.c dictionary.h

spell.o: spell.c
	afl-gcc -Wall --std=c99 -c spell.c

test.o: test_main.c
	gcc -Wall --std=c99 -c tests/test_main.c

main.o: main.c
	afl-gcc -Wall --std=c99 -c main.c
...
prog: dictionary.o spell.o main.o
	afl-gcc -Wall  --std=c99 -o spell_check dictionary.o spell.o main.o
